...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateRangeInput(oTable) {
            ...
            */
	        ...
	        function (oSettings, aData, iDataIndex) {
	            ...
	            var iValue = 0;
	            try {
	                iValue = parseFloat(aData[_fnColumnIndex(index)] == "-" ? 0 : aData[_fnColumnIndex(index)].replace(',', '.') * 1);
	            } catch (e) {
	                iValue = 0;
	            }
	            if (isNaN(iValue)) {
        ...
        function fnCreateDropdown(aData) {
            ...
            var index = i;
            var r = '<div class="dropdown select_filter form-control"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span>' + label + '</span><b class="caret"></b></a><ul class="dropdown-menu" role="menu"><li data-value=""><a>Показать все</a></li>', j, iLen = aData.length;
            ...
            select.find('li').click(function () {
                ...
                $(this).parent().parent().find('.dropdown-toggle').html('<span>' + ($(this).data('value') == '' ? 'Показать все' : $(this).data('value')) + '</span>' + '<b class="caret"></b>');
        ...
        return this.each(function () {
            ...
            $(aoFilterCells).each(function (index) {//fix for ColVis
                ...
                i = index;
                if (!$(aoFilterCells[i].cell).find('input[type="checkbox"]').length) {
                    var aoColumn = {
                        type: "text",
                        bRegex: false,
                        bSmart: true,
